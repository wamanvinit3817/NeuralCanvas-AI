...
def parse_arguments():
    ...
    parser.add_argument('--content-dir',type=str,default='D:\AI ML DL - PRIME\Major Project II - NST\content_data',help='Location of content dataset')
    parser.add_argument('--style-dir',type=str,default='D:\AI ML DL - PRIME\Major Project II - NST\style_data',help='Location of style dataset')
    parser.add_argument('--vgg',type=str,default='D:\AI ML DL - PRIME\Major Project II - NST\VGG_normalised.pth',help='Location of pretrained vgg')
    parser.add_argument('--experiment',type=str,default='experment1',help="Name of experiment")
    parser.add_argument('--final_size',type=int,default=256,help='Size of final image')
    parser.add_argument('--content_size',type=int,default=512,help='Content image size')
    ...
    parser.add_argument('--log_interval',type=int,default=1,help='Logging intervals')
...
def main():
    ...
    style_transforms = get_transforms(args.content_size,args.crop,args.final_size)
    content_transforms = None
    content_transforms = get_transforms(args.style_size,args.crop,args.final_size)
    
    content_dataset = ImageFolderDataset(args.content_dir,content_transforms)
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.log_interval == 0:
            tqdm.write(f'Epoch [{epoch + 1} / {args.epochs}] : Loss : {running_loss:4f} | CLoss : {running_closs:4f} | Sloss : {running_sloss:4f}')
